...
public class LevelProgressUI : MonoBehaviour
{
    ...
    private float GetDistance() => (endLinePosition - playerTransform.position).sqrMagnitude;

    private void UpdateProgressFill(float value) => uiFillImage.fillAmount = value;
